...
<div class="header">	
      <div class="container"> 
         <div class="header-top">
      		 <div class="logo">
				<a href="index.jsp"><h6>Datta Furnitures</h6><h2>Pune</h2></a>
			 </div>
		 ...
		 <div class="banner_wrap">
			<div class="bannertop_box">
	  			...
	  			<div class="welcome_box">
	  				<h3>Welcome to Datta Furniture</h3>
	  				<p>This furniture has been one Pune's one of the best furniture shops with the satisfaction of users</p>
	  			</div>
   		 	</div>
   		 	<div class="banner_right">
   		 		<h1>Datta Furniture <br>Best in Pune</h1>
   		 		<p>This has been best choice of customers since manufacturing</p>
