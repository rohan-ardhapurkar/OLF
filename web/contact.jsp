...
<html>
    ...
    <body>
        <div class="header">
            <div class="container">
                <div class="header-top">
                    <div class="logo">
                        <a href="index.jsp"><h6>Online Furnish</h6><h2>Luxury</h2></a>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                                ...
                                <div class="contact_grid span_2_of_contact_right">
                                    ...
                                    <div class="address">
                                        ...
                                        <div class="contact_address">
                                            P-12, Bunglow Number 32, Gulwani  Maharaj Road, Kothrud, Pune
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="address">
                                    ...
                                    <div class="address">
                                        ...
                                        <div class="contact_email">
                                            <p>Email : <a href="mailto:a.rohancool@gmail.com">info@dattafurnitures.com</a></p>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                            ...
                            <div class="map">   	 
                                <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.mapsdirections.info/en/custom-google-maps/map.php?width=100%&height=600&hl=ru&coord=18.500454,73.823612&q=2%2C%20Gulawani%20Maharaj%20Road%2C%20Kothrud%2C%20Pune%2C%20Maharashtra%20411038+(Tech%20hub)&ie=UTF8&t=&z=14&iwloc=A&output=embed"></iframe><br><small><a href="https://www.mapsdirections.info/en/custom-google-maps/map.php?width=100%&height=600&hl=ru&coord=18.500454,73.823612&q=2%2C%20Gulawani%20Maharaj%20Road%2C%20Kothrud%2C%20Pune%2C%20Maharashtra%20411038+(Tech%20hub)&ie=UTF8&t=&z=14&iwloc=A&output=embed" style="color:#666;text-align:left;font-size:12px"></a></small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="footer-grid">
                    ...
                    <ul class="list1">
                        ...
                        <li><a href="about.jsp">Eshop</a></li>
                        <li><a href="about.jsp">Features</a></li>
                        <li><a href="about.jsp">New Collections</a></li>
                        <li><a href="typo.jsp">Typo</a></li>
                ...
                <div class="footer-grid">
                    ...
                    <ul class="list1">
                        ...
                        <li><a href="contact.jsp">Personal information</a></li>
                        <li><a href="contact.jsp">Addresses</a></li>
                        <li><a href="#">Discount</a></li>
                        <li><a href="checkout.jsp">Orders history</a></li>
                        <li><a href="about.jsp">Search Terms</a></li>
                    </ul>
                </div>
                <div class="footer-grid">
                    <h3>Our Support</h3>
                    <ul class="list1">
                        ...
                        <li><a href="about.jsp">Search Terms</a></li>
                        <li><a href="about.jsp">Advanced Search</a></li>
                        <li><a href="about.jsp">Mobile</a></li>
                        <li><a href="contact.jsp">Contact Us</a></li>
                        <li><a href="contact.jsp">Mobile</a></li>
                        <li><a href="contact.jsp">Addresses</a></li>
                    </ul>
                </div>
                <div class="footer-grid">
                    <h3>Newsletter</h3>
                    <p class="footer_desc">Nostru</p>
        ...
        <div class="footer_bottom">
            <div class="container">
                <div class="copy">
                    <p>Copyright &copy; 2017 Datta Furniture. All Rights Reserved . Design by <a href="http://creazionessoftwares.com/" target="_blank">W3layouts</a> </p>
                </div>
            </div>
        </div>
    </body>
